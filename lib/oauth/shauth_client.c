...
static void shauth_client_usage (char *program_name) {
 ...
 */
int shauth_client_main (int argc, char **argv) {
  ...
  if (argc !=7) shauth_client_usage(argv[0]);
  ...
  else shauth_client_usage(argv[0]);
